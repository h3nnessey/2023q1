...
class Minesweeper {
  ...
  initWithState(state) {
    ...
    if (!this.state.gameOver && !this.state.gameStarted && !this.state.stepsCount) {
      this.state.booleanMatrix = this.createBooleanMatrix();
    }
  ...
  createGameInfo() {
    ...
    controlsContainer.append(
      ...
      Minesweeper.createButton(
        ...
        'Save current game and pause it.',
      ),
  ...
  static createButton(classMod, handler, title) {
  ...
  createSettings() {
    ...
    const volumeButton = Minesweeper.createButton('volume', () => {
    ...
    const btn = Minesweeper.createButton('toggle-leaderboard', () => {
  ...
  createLeaderboard() {
    ...
    container.append(
      ul,
      Minesweeper.createButton('close', () => {
  ...
  handleCellClick = (e) => {
    ...
    if (target) {
      ...
      if (this.isBomb(target)) {
        target.classList.add('opened', 'bomb', 'triggered-bomb');
  ...
  saveState = () => {
    if (
      (!this.state.gameOver && !this.state.gameStarted && !this.state.stepsCount)
      || this.state.gameOver
    ) {
      this.state = {
        ...this.state,
